...
const UserAccountForm = () => {
    ...
    return (
        ...
        >
            ...
            <h1 className="text-base sm:text-2xl font-bold sm:font-semibold text-center text-blue-800 mb-4 sm:mb-4 underline underline-offset-8 decoration-gray-500/80">
